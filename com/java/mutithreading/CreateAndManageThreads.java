...
public class CreateAndManageThreads {
    static class SMSThread extends Thread {
        public void run() {
            try {
    ...
    static class ETACalculationThread extends Thread {
        public void run() {
            try {
...
class Main {
    public static void main(String[] args) {
        ...
        CreateAndManageThreads.SMSThread smsThread = new CreateAndManageThreads.SMSThread();
        CreateAndManageThreads.EmailThread emailThread = new CreateAndManageThreads.EmailThread();
        CreateAndManageThreads.ETACalculationThread etaThread = new CreateAndManageThreads.ETACalculationThread();
